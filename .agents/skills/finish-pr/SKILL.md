...
- [ ] parallel: Bugbot fixes | review (react-dev + performance-review.md)
- [ ] rebase merge
```
...
**Review** — load [`react-dev`](../react-dev/SKILL.md) and [performance-review.md](references/performance-review.md); fix findings → finish-work + push.
